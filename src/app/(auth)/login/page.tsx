...
function Page() {
  ...
  return (
    <>
      <Head>
        <title>Login - MarketNest | Access Your Account</title>
        <meta
          name="description"
          content="Log in to your MarketNest account to manage your e-commerce business and access exclusive features."
        />
        <meta
          name="keywords"
          content="login, MarketNest, e-commerce, account access"
        />
      </Head>
      <div
