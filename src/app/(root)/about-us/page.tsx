...
function Page() {
  return (
    <>
      <Head>
        <title>About Us - MarketNest | Your Trusted E-Commerce Partner</title>
        <meta
          name="description"
          content="Learn more about MarketNest, your trusted e-commerce platform. Discover our mission, values, and the team dedicated to helping your online business succeed."
        />
        <meta
          name="keywords"
          content="About MarketNest, e-commerce platform, online business, our mission, team"
        />
      </Head>
